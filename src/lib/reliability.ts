...
// 신뢰도 기준(스펙 "확정의 실제 조건"의 무게 신호 세 가지, 질문흐름 v0.34): 두 개 이상 충족하면 확정이고, 그 개수로 등급을 나눈다.
//   2개 = 중, 3개 = 상 (신호가 네 개였던 v0.33까지의 세션은 저장된 등급 "최상"이 그대로 보인다)
// 신호 문구는 참가자에게 그대로 보인다.
export const SIGNAL_LABEL = {
  added: "요구된 것 말고 스스로 보탠 부분",
  satisfaction: "과정이나 결과물 자체에서 얻은 만족",
