...
const sample = {
  ...
  situation: "exploring",
  reliability: [
    { grade: "최상", met: ["요구된 것보다 더 들인 수고", "다른 때에도 되풀이한 행동", "결과가 아니라 행동 자체에서 얻은 만족"] },
    { grade: "상", met: ["요구된 것보다 더 들인 수고", "다른 때에도 되풀이한 행동"] },
    { grade: "상", met: ["결과가 아니라 행동 자체에서 얻은 만족", "다른 방법도 해봤지만 이 방식으로 돌아옴"] },
  ],
  targets: {
    survivors: [
